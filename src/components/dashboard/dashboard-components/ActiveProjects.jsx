  ...
  return (
    <div>
      ...
      <Box position="relative" h="100%">
        <Swiper modules={[Pagination, Autoplay]} pagination={{ dynamicBullet: true }} spaceBetween={20} slidesPerView={1} autoplay={{delay: 3000, disableOnInteraction: false}} className="MySwiper">
                    ...
                    <Flex justify="space-between" align="center" mb={1}>
                      <Box>
                        ...
                        <Text fontSize="sm" color="gray.500">
                          Provider:{" "}
                          <Link color="#197FCF" fontWeight="medium" href={project.providerLink}>
                            {project.provider}
                          </Link>
                        </Text>
                      </Box>
