...
const StepThree = () => {
  ...
  return (
    <Box w="100%" maxW="550px" textAlign="center">
      ...
      <Text fontSize="sm" color="gray.600" mb={6}>
        Great job so far! Now, 😄 let&apos;s set up a secure password for your account.
      </Text>

      <Box spaceY={10} mb={20}>
        <PasswordField label="Type your secure password" name="password" />
        <PasswordField label="Confirm your secure password" name="passwordReapeat" />
      </Box>
