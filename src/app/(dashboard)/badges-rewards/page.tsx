...
const BadgesRewardsPage: React.FC = () => {
  ...
  const sectionOptions = [
    ...
    { key: 'leaderboards', label: 'Leaderboards', icon: FaTrophy },
  ];
        ...
        <Grid templateColumns={{ base: '1fr', md: 'repeat(4, 1fr)' }} gap={4}>
          <Card>
            <CardBody textAlign="center">
              <Icon as={FiAward} boxSize={6} color="green.500" mb={2} />
          ...
          <Card>
            <CardBody textAlign="center">
              <Icon as={FiTarget} boxSize={6} color="blue.500" mb={2} />
          ...
          <Card>
            <CardBody textAlign="center">
              <Icon as={FaTrophy} boxSize={6} color="purple.500" mb={2} />
              ...
              <VStack gap={6} align="stretch">
                ...
                {earnedBadges.length === 0 && (
                  <Box textAlign="center" py={8}>
                    <Icon as={FiLock} boxSize={12} color="gray.300" mb={4} />
                        ...
                        <HStack gap={4} align="start">
                          <Box position="relative">
                            <Box
                              ...
                              opacity={0.7}
                            >
                              <Icon as={badge.icon} boxSize={5} color="gray.400" />
                            </Box>
                            <Badge
                              position="absolute"
                              top="-1"
                          ...
                          >
                            <HStack justify="space-between">
                              ...
                              <HStack gap={2}>
                                ...
                                <Icon
                                  as={entry.change === 'up' ? FiTrendingUp : entry.change === 'down' ? FiClock : FiCheckCircle}
                                  color={entry.change === 'up' ? 'green.500' : entry.change === 'down' ? 'red.500' : 'gray.500'}
                                />
                              </HStack>
                            </HStack>
                          </Box>
                  ...
                  <CardBody>
                    <VStack gap={4}>
                      <Box textAlign="center" p={6} bg="gradient-to-r from-purple-50 to-blue-50" borderRadius="lg" border="2px" borderColor="purple.200">
                        <Icon as={FaTrophy} boxSize={12} color="gold" mb={4} />
...
export default BadgesRewardsPage;
